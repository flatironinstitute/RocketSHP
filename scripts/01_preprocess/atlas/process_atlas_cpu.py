...
out_path = ATLAS_PROCESSED_DATA_DIR / f"atlas_derivatives_v2_4162_4167"
...
for (s0, s1) in subsets:
    ds = Dataset.load_from_disk(str(ATLAS_PROCESSED_DATA_DIR / f"atlas_derivatives_v2_{s0}_{s1}"))
    all_ds.append(ds)
