...
disbatch_prefix = "#DISBATCH PREFIX ( cd ${PLANET_MD_DIR:-$HOME/PLANET-MD} ; module load cudnn; module load nccl; module load cuda; module load foldseek; source ${PLANET_MD_VENV:-$HOME/PLANET-MD/.venv}/bin/activate; python scripts/01_preprocess/atlas/foldseek_shp_disbatch_single.py "
