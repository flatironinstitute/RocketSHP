...
atlas_shp_data = Dataset.load_from_disk(
    str(ATLAS_PROCESSED_DATA_DIR / "esm_shp/dataset")
)
atlas_foldseek_shp_data = Dataset.load_from_disk(
    str(ATLAS_PROCESSED_DATA_DIR / "fs_shp/dataset")
)
# %%
# Build file
