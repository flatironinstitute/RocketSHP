    ...
    for i, mdc_f in enumerate(tqdm(mdcath_files,desc="Computing GCC-LMI")):
        ...
        for rep in range(N_REPS):
            for temp in TEMPS:
                ...
                pdb_f, xtc_f = convert_to_files(mdc_f, replica_list=[rep], temp_list=[temp],directory="/tmp/")
                ...
                update_h5_dataset(h5file, f"{pdb_code}/T{temp}/R{rep}/gcc_lmi", gcorr, overwrite=True)
