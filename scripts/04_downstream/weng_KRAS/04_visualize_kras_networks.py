...
pairwise_correlation_to_network(masked_net, thresh=0.5, title="By Node Index", seed=NETWORK_PLOT_SEED, ax=ax[1])

# to color pymol chain: spectrum resi, firebrick_paleyellow_deepblue, chain A

display_network(masked_net, title="By Community", node_color=clust_colors, edge_color="gray", seed=NETWORK_PLOT_SEED, ax=ax[2])
...
fig, ax = plt.subplots(1, 1, figsize=(10, 10))
pairwise_correlation_to_network(masked_net, thresh=0.5, title="By Node Index", seed=NETWORK_PLOT_SEED, ax=ax)
plt.tight_layout()
plt.savefig(config.REPORTS_DIR / EVAL_KEY / "kras_gcc_lmi_by_node_index.svg")

fig, ax = plt.subplots(1, 1, figsize=(10, 10))
display_network(masked_net, title="By Community", node_color=clust_colors, edge_color="gray", seed=NETWORK_PLOT_SEED, ax=ax)
plt.tight_layout()
